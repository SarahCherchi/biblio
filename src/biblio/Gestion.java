...
public class Gestion {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println("1.Auteur 2.Ouvrages 3.Lecteur 4.Rayon 5.Exemplaire 6.Louer 7.Rendre 8.Fin");
            choix=sc.nextInt();
            switch (choix){
                case 1 : gestAuteur();
                    break;
    ...
    private static void gestOuvrage() {
        //TODO  Ajout Ouvrage ==>choisir un type d'ouvrage (Livre,CD,DVD) encoder toutes les données, choisir un ou plusieurs auteurs  ==> ajouter à la liste des Ouvrages.
    }

    private static void gestAuteur() {
        //TODO Ajout Auteur ==> encoder toutes les données => ajouter à la liste des écrivains
    }
}
// TODO pour la semaine prochain coder remove a.remove(o) o.remove(e) r.remove(e)
// ne pas mettre dans le populate juste coder les méthodes

//TODO créer un menu générale voir énoncé moodle

//TODO ajouter méth UML
